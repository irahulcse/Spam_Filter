...
#%%
new='Aaayushi will be going to go to the home next week'
pm=process_message(new)
alldonewithflyingcolors(pm,new)

#%%
new='Got $500 as a gift coupon'
pm=process_message(new)
alldonewithflyingcolors(pm,new)

#%%
new='Subhu is the thief asking for $500'
pm=process_message(new)
alldonewithflyingcolors(pm,new)

#%% 
new='Satapda is asking for the bride $500'
pm=process_message(new)
alldonewithflyingcolors(pm,new)
